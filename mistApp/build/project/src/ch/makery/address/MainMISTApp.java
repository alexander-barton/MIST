...
public class MainMISTApp extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle("Montreal Imaging Stress Task");
	...
	public void makeTests(int[] intVar, boolean[] booVar, char[] charVar, String[] stringVar, ScanSig scanSig){

	    this.testSettings = new TestSettings(intVar, booVar, charVar, stringVar, scanSig);
